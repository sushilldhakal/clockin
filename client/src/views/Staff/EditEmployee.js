...
export default ({user, onUpdate}) => {
    ...
    const updateEmployee = ()=> {
        axios.post(API_SERVER+ 'employee/update/'+employee._id, employee).then(res => {
          alert('User updated successfully')
          onUpdate()
        })
    }

    return <form className="add-employee-form">
                    ...
                    <Form.Row>
                      <Form.Group as={Col} controlId="formGridEmail">
                        ...
                        <input
                          ...
                          type="email"
                          name="email"
                          onChange={(e) => setUser({...employee, email: e.target.value})}
                      ...
                      <Form.Group as={Col} controlId="formGridPhone">
                        ...
                        <input
                          ...
                          type="number"
                          name="phone"
                          onChange={(e) => setUser({...employee, phone: e.target.value})}
